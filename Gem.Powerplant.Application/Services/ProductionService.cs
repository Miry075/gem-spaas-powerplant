...
public class ProductionService : IProductionService
{
    ...
    public IEnumerable<PowerplantProduction> DispatchProduction(double load,
        IEnumerable<PowerplantModel> powerplants,
        FuelsInfo fuelsInfo)
    {
        ...
        var dispatchState = new List<(PowerplantModel plant, double production)>();
    ...
    private static bool TryRebalanceForShortfall(
        List<(PowerplantModel plant,
        double production)> dispatchState,
        double shortfall)
    {
    ...
    private static double GetEffectivePMax(
        PowerplantModel powerplant,
        FuelsInfo fuelsInfo)
    {
