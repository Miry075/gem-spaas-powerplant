...
public class ProductionServiceShould
{
    ...
    public void DispatchProduction_AssignsCorrectlyForExactLoad()
    {
        var plants = new[]
        {
            new PowerplantModel { Name = "p1", Type = PowerplantType.GasFired, Efficiency = 1, PMax = 100, PMin = 0 },
            new PowerplantModel { Name = "p2", Type = PowerplantType.GasFired, Efficiency = 1, PMax = 50, PMin = 0 },
        };
    ...
    public void DispatchProduction_RebalancesAcrossMultiplePlants_WhenShortfallBelowPmin()
    {
        ...
        {
            new PowerplantModel { Name = "p1", Type = PowerplantType.GasFired, Efficiency = 1, PMax = 100, PMin = 0 },
            new PowerplantModel { Name = "p2", Type = PowerplantType.GasFired, Efficiency = 1, PMax = 100, PMin = 60 },
            new PowerplantModel { Name = "p3", Type = PowerplantType.GasFired, Efficiency = 1, PMax = 100, PMin = 60 },
        };
